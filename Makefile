# This Makefile is for the Gtk2::Ex::PrintDialog extension to perl.
#
...
#     NAME => q[Gtk2::Ex::PrintDialog]
#     PREREQ_FATAL => q[1]
#     PREREQ_PM => { File::Temp=>q[0], File::Spec=>q[0], Locale::gettext=>q[0], Gtk2=>q[0], File::Basename=>q[0] }
#     VERSION_FROM => q[lib/Gtk2/Ex/PrintDialog.pm]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Gtk2/Ex/PrintDialog.pm \
	lib/Gtk2/Ex/PrintDialog/Darwin.pm \
	lib/Gtk2/Ex/PrintDialog/Linux.pm \
	lib/Gtk2/Ex/PrintDialog/MSWin32.pm \
	lib/Gtk2/Ex/PrintDialog/Unix.pm
...
TO_INST_PM = lib/Gtk2/Ex/PrintDialog.pm \
	lib/Gtk2/Ex/PrintDialog/Darwin.pm \
	lib/Gtk2/Ex/PrintDialog/Linux.pm \
	lib/Gtk2/Ex/PrintDialog/MSWin32.pm \
	lib/Gtk2/Ex/PrintDialog/Unix.pm

PM_TO_BLIB = lib/Gtk2/Ex/PrintDialog/MSWin32.pm \
	blib/lib/Gtk2/Ex/PrintDialog/MSWin32.pm \
	lib/Gtk2/Ex/PrintDialog/Linux.pm \
	blib/lib/Gtk2/Ex/PrintDialog/Linux.pm \
	lib/Gtk2/Ex/PrintDialog/Darwin.pm \
	blib/lib/Gtk2/Ex/PrintDialog/Darwin.pm \
	lib/Gtk2/Ex/PrintDialog/Unix.pm \
	blib/lib/Gtk2/Ex/PrintDialog/Unix.pm \
	lib/Gtk2/Ex/PrintDialog.pm \
	blib/lib/Gtk2/Ex/PrintDialog.pm
...
DISTNAME = Gtk2-Ex-PrintDialog
DISTVNAME = Gtk2-Ex-PrintDialog-0.02
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/Gtk2/Ex/PrintDialog/MSWin32.pm $(INST_MAN3DIR)/Gtk2::Ex::PrintDialog::MSWin32.$(MAN3EXT) \
	  lib/Gtk2/Ex/PrintDialog/Linux.pm $(INST_MAN3DIR)/Gtk2::Ex::PrintDialog::Linux.$(MAN3EXT) \
	  lib/Gtk2/Ex/PrintDialog/Darwin.pm $(INST_MAN3DIR)/Gtk2::Ex::PrintDialog::Darwin.$(MAN3EXT) \
	  lib/Gtk2/Ex/PrintDialog/Unix.pm $(INST_MAN3DIR)/Gtk2::Ex::PrintDialog::Unix.$(MAN3EXT) \
	  lib/Gtk2/Ex/PrintDialog.pm $(INST_MAN3DIR)/Gtk2::Ex::PrintDialog.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Gtk2/Ex/PrintDialog.pm blib/lib/Gtk2/Ex/PrintDialog/Unix.pm blib/lib/Gtk2/Ex/PrintDialog/Linux.pm blib/lib/Gtk2/Ex/PrintDialog/MSWin32.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
	$(RM_F) blib/lib/Gtk2/Ex/PrintDialog/Darwin.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Gtk2-Ex-PrintDialog' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.02' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Gtk2/Ex/PrintDialog.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    File::Basename:                0' >> META.yml
	$(NOECHO) $(ECHO) '    File::Spec:                    0' >> META.yml
	$(NOECHO) $(ECHO) '    File::Temp:                    0' >> META.yml
	$(NOECHO) $(ECHO) '    Gtk2:                          0' >> META.yml
	$(NOECHO) $(ECHO) '    Locale::gettext:               0' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Locale-gettext" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Gtk2/Ex/PrintDialog/MSWin32.pm blib/lib/Gtk2/Ex/PrintDialog/MSWin32.pm \
	  lib/Gtk2/Ex/PrintDialog/Linux.pm blib/lib/Gtk2/Ex/PrintDialog/Linux.pm \
	  lib/Gtk2/Ex/PrintDialog/Darwin.pm blib/lib/Gtk2/Ex/PrintDialog/Darwin.pm \
	  lib/Gtk2/Ex/PrintDialog/Unix.pm blib/lib/Gtk2/Ex/PrintDialog/Unix.pm \
	  lib/Gtk2/Ex/PrintDialog.pm blib/lib/Gtk2/Ex/PrintDialog.pm 
	$(NOECHO) $(TOUCH) $@
